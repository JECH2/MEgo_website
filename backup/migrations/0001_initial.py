    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_people', models.CharField(blank=True, max_length=200, null=True)),
                ('related_place', models.CharField(blank=True, max_length=200, null=True)),
                ('photo', models.ImageField(blank=True, upload_to=MEgo.models.user_path)),
                ('thumbnail_photo', models.ImageField(blank=True, upload_to=MEgo.models.user_path)),
